  ...
  <div class="flex w-full max-w-sm flex-col space-y-6">
      <Card class="shadow-lg border border-border bg-card text-foreground">
          <CardHeader class="text-center">
              <CardTitle class="text-lg font-semibold">Welcome</CardTitle>
          ...
          <CardContent>
              <div class="space-y-4">
                  ...
                  <div class="relative text-center text-sm border-t border-border pt-3">
                  ...
                  <Button class="w-full bg-black text-white hover:bg-primary/90" on:click={handleLogin}>
                      Login 
                  </Button>
